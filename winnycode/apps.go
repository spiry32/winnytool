...
var applications = map[string]string{
	...
	"Chromium":    "https://github.com/Hibbiki/chromium-win64/releases/download/v125.0.6422.113-r1287751/mini_installer.sync.exe",
	"Brave":       "https://laptop-updates.brave.com/latest/winx64",

	"Vivaldi":              "https://downloads.vivaldi.com/stable/Vivaldi.6.7.3329.35.x64.exe",
	...
	"GoLang":             "https://go.dev/dl/go1.22.3.windows-amd64.msi",
