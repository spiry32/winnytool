...
var applications = map[string]string{
	...
	"Chromium":             "https://github.com/Hibbiki/chromium-win64/releases/download/v133.0.6943.127-r1402768/mini_installer.sync.exe",
	"Brave":                "https://laptop-updates.brave.com/latest/winx64",
	"Vivaldi":              "https://downloads.vivaldi.com/stable/Vivaldi.7.1.3570.54.x64.exe",
	...
	"LibreWolf":            "https://gitlab.com/api/v4/projects/44042130/packages/generic/librewolf/135.0.1-1/librewolf-135.0.1-1-windows-x86_64-setup.exe",
	"Waterfox":             "https://cdn1.waterfox.net/waterfox/releases/latest/windows",
	"Floorp Browser":       "https://github.com/Floorp-Projects/Floorp/releases/download/v11.23.1/floorp-win64.installer.exe",
	"Tor Browser":          "https://www.torproject.org/dist/torbrowser/14.0.6/tor-browser-windows-x86_64-portable-14.0.6.exe",
	"Avast Secure Browser": "https://www.avast.com/download-thank-you.php?product=ASB&locale=en-ww&direct=1",
	"Thorium":              "https://github.com/Alex313031/Thorium-Win/releases/download/M130.0.6723.174/thorium_AVX2_mini_installer.exe",
	"Mercury":              "https://github.com/Alex313031/Mercury/releases/download/v.129.0.2/mercury_129.0.2_win64_AVX2_installer.exe",
